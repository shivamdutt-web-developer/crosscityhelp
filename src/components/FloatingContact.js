    ...
    <>
      ...
      <div className="fixed left-0 top-1/2 -translate-y-1/2 z-[60] hidden lg:block">
        <a 
          ...
          className="bg-[#1e40af] text-white flex items-center gap-4 px-5 py-10 rounded-r-3xl shadow-2xl hover:bg-blue-700 transition-all hover:pl-8 group border-y border-r border-white/20"
          style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}
        >
          <span className="font-black tracking-[0.25em] text-lg md:text-xl whitespace-nowrap drop-shadow-md">
            +1 (226) 319-1708
          </span>
          <Phone className="rotate-90 group-hover:scale-125 transition-transform" size={24} />
        </a>
      </div>
