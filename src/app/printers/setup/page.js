...
const printerBrands = [
  ...
  { name: "Other", icon: "/images/printer-setup/other.png", fallbackIcon: null, color: "from-emerald-600 to-emerald-400" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="relative pt-40 pb-16 lg:pb-32 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div 
          className="absolute top-0 left-0 w-full h-full -z-10 bg-[url('/images/printer-setup/hero-bg-v2.png')] bg-cover bg-center opacity-30 blur-[2px]"
          aria-hidden="true"
        ></div>
        <div className="absolute inset-0 -z-10 bg-gradient-to-b from-white/60 via-transparent to-slate-50/90"></div>
